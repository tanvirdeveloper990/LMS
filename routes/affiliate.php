...
Route::prefix('affiliate')->name('affiliate.')->group(function () {
    ...
    Route::middleware('auth:affiliate')->group(function () {
        ...
        Route::get('level', [AffiliateController::class, 'level'])->name('level');
        Route::get('sales-products', [AffiliateController::class, 'salesProducts'])->name('sales-products');
        Route::get('sales-products-earning', [AffiliateController::class, 'salesProductsEarning'])->name('sales-products-earning');
        Route::get('sales-products-withdrawal-hostory', [AffiliateController::class, 'salesProductsWithdrawalHistory'])->name('sales-products-withdrawal-hostory');
        Route::get('level-withdrawal', [AffiliateController::class, 'levelWithdrawal'])->name('level-withdraw');
        Route::post('/withdraw-level-store', [AffiliateController::class, 'storeWithdrawLevel'])->name('withdraw-level.store');
