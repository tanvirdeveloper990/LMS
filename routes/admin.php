...
use App\Http\Controllers\Admin\EbookProductController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::resource('ebook-products', EbookProductController::class)->parameters(['ebook-products' => 'ebook_product']);

        Route::delete('/ebook-products/remove-image/{id}', [EbookProductController::class, 'removeImage'])->name('ebook-products.removeImage');
