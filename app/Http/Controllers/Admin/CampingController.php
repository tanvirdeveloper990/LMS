...
class CampingController extends Controller
{
    ...
    {
        $this->middleware('permission:view camping')->only('index');
        $this->middleware('permission:create camping')->only(['create', 'store']);
        $this->middleware('permission:edit camping')->only(['edit', 'update']);
        $this->middleware('permission:delete camping')->only('destroy');
    }
    /**
