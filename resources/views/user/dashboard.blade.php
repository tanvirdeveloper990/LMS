...
<section class="content px-4 py-4">
    <div class="container mx-auto">
        ...
        {{-- ✅ Reward Points Card --}}
        <div class="col-12">
            <h5 class="text-blue-600 font-semibold mb-2">Reward Points</h5>
            <hr class="border-blue-300 mb-6">
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="text-black p-5 rounded-2xl shadow hover:scale-105 transform transition"
                style="background: linear-gradient(135deg, #F4C430 0%, #D4AF37 50%, #B8860B 100%);">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-bold uppercase">Reward Points</p>
                        <h3 class="text-3xl font-black mt-2">{{ number_format($reward_points) }}</h3>
                        <p class="text-xs font-semibold mt-1 opacity-80">≈ {{ currency() }}{{ number_format($reward_points, 2) }} usable at checkout</p>
                    </div>
                    <div class="bg-black/15 p-3 rounded-full">
         ...
         <div class="col-12">
            <h5 class="text-blue-600 font-semibold mb-2">Product Order</h5>
            <hr class="border-blue-300 mb-6">
        </div>
    ...
    {{--<div class="container mx-auto mt-8">
         <div class="col-12">
            <h5 class="text-blue-600 font-semibold mb-2">Level Revenue</h5>
            <hr class="border-blue-300 mb-6">
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-purple-500 text-white p-5 rounded-2xl shadow hover:scale-105 transform transition">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium uppercase">Total Quantity</p>
                        <h3 class="text-2xl font-bold mt-2">{{ $level_product_count }}</h3>
                    </div>
                    <div class="bg-purple-700 p-3 rounded-full">
                        <i class="fas fa-shopping-cart text-white text-xl"></i>
                    </div>
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-400 text-white p-5 rounded-2xl shadow hover:scale-105 transform transition">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium uppercase">Total Sales</p>
                        <h3 class="text-2xl font-bold mt-2">{{ currency() }}{{ number_format($level_product_total_sales, 2) }}</h3>
                    </div>
                    <div class="bg-yellow-600 p-3 rounded-full">
                        <i class="fas fa-hourglass-half text-white text-xl"></i>
                    </div>
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-500 text-white p-5 rounded-2xl shadow hover:scale-105 transform transition">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium uppercase">Total Revenue</p>
                        <h3 class="text-2xl font-bold mt-2">{{ currency() }}{{ number_format($level_commission_earning, 2) }}</h3>
                    </div>
                    <div class="bg-green-700 p-3 rounded-full">
                        <i class="fas fa-check-circle text-white text-xl"></i>
                    </div>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-5 rounded-2xl shadow hover:scale-105 transform transition">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium uppercase">Withdrawal</p>
                        <h3 class="text-2xl font-bold mt-2">{{ currency() }}{{ number_format($level_commission_withdrawal, 2) }}</h3>
                    </div>
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-500 text-white p-5 rounded-2xl shadow hover:scale-105 transform transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold mt-2">{{ currency() }}{{ number_format($level_commission_earning - $level_commission_withdrawal, 2) }}</h3>
                    </div>
                    <div class="bg-green-700 p-3 rounded-full">
                        <i class="fas fa-check-circle text-white text-xl"></i>
                    </div>
