    ...
    <div class="row g-4">
            ...
            <div class="card text-white bg-primary shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($totalSales, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-warning shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Vat Amount</p>
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($commissionAmount, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-hourglass-half fs-5"></i>
                    </div>
