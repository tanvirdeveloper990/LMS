  ...
  <div class="notice-bar">
    ...
    <div class="marquee-wrap">
      <div class="marquee-track">
        <span>২০২৬ শিক্ষাবর্ষের নতুন ব্যাচে ভর্তি চলছে। বিস্তারিত জানতে ভিজিট করুন।</span>
        <span>নিয়মিত ক্লাস, লাইভ এক্সাম ও শিক্ষক সহায়তায় প্রস্তুতি নিন আরও সহজে।</span>
        <!-- duplicate for seamless loop -->
        <span aria-hidden="true">২০২৬ শিক্ষাবর্ষের নতুন ব্যাচে ভর্তি চলছে। বিস্তারিত জানতে ভিজিট করুন।</span>
        <span aria-hidden="true">নিয়মিত ক্লাস, লাইভ এক্সাম ও শিক্ষক সহায়তায় প্রস্তুতি নিন আরও সহজে।</span>
      </div>
    </div>
  </div>
  ...
  <header class="site-header">
    <div class="container">
      <div class="header-inner">
        ...
        <!-- mobile hamburger -->
        <button class="menu-toggle d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSidebar"
  ...
  <div class="offcanvas offcanvas-start mobile-sidebar" tabindex="-1" id="mobileSidebar">
    ...
    <div class="offcanvas-body">
      <ul class="sidebar-nav">
        ...
        <li class="has-dropdown">
          <button type="button" class="dropdown-trigger">ক্যাটাগরিসমূহ <i class="bi bi-chevron-down"></i></button>
