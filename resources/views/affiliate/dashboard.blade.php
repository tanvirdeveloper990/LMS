...
<div class="container-fluid py-4">
    ...
    <div class="row g-4 mt-2">
        <div class="col-12">
            <h5 class="text-primary">Affiliate Revenue</h5>
            <hr>
        </div>
        <!-- Total Orders -->
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-indigo shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Withdrawal</p>
    ...
    <div class="row g-4 mt-2">
        <div class="col-12">
            <h5 class="text-primary">Level Revenue</h5>
            <hr>
        </div>
        <!-- Total Orders -->
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-gradient-purple shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Total Quantity</p>
                        <h4 class="fw-bold">{{ $level_product_count }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-shopping-cart fs-5"></i>
                    </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-warning shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Total Sales</p>
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($level_product_total_sales, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-hourglass-half fs-5"></i>
                    </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-success shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Total Revenue</p>
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($level_commission_earning, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-check-circle fs-5"></i>
                    </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-primary shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Withdrawal</p>
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($level_commission_withdrawal, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-dollar-sign fs-5"></i>
                    </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-pink shadow-sm h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 small text-uppercase">Balance</p>
                        <h4 class="fw-bold">{{ currency() }}{{ number_format($level_commission_earning - $level_commission_withdrawal, 2) }}</h4>
                    </div>
                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                        <i class="fas fa-tags fs-5"></i>
                    </div>
