            ...
            <div class="row g-3">
               ...
               <div class="col-md-6">
                    ...
                    <select name="promotion_method" class="form-select form-control @error('promotion_method') is-invalid @enderror" required>
                        ...
                        <option value="blog" {{ (old('promotion_method', auth('affiliate')->user()->promotion_method) == 'blog') ? 'selected' : '' }}>Blog/Website</option>
                        <option value="youtube" {{ (old('promotion_method', auth('affiliate')->user()->promotion_method) == 'youtube') ? 'selected' : '' }}>YouTube</option>
                        <option value="social" {{ (old('promotion_method', auth('affiliate')->user()->promotion_method) == 'social') ? 'selected' : '' }}>Social Media</option>
                        <option value="email" {{ (old('promotion_method', auth('affiliate')->user()->promotion_method) == 'email') ? 'selected' : '' }}>Email Marketing</option>
                    </select>
                </div>
