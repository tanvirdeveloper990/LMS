...
<div class="container py-2 min-vh-100">
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center text-success">
            ...
            <a href="{{ route('affiliate.withdraw') }}" class="btn btn-success"><i class="fas fa-credit-card me-2"></i> Add Withdrawal</a>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <div>
                    ...
                    <p class="text-primary">{{ currency() }}{{ number_format($totalPendingCommission, 2) }}</p>
                </div>
            </div>
