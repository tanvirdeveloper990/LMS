                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('admin.customer-contact.edit',$item->id) }}" class="btn btn-sm btn-primary p-2 rounded-circle">
                                            <i class="fa fa-edit text-xs"></i>
                                        </a>
                                       
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('admin.customer-contact.destroy', $item->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
