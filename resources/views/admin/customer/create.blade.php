                        ...
                        <form action="{{ route('admin.customer-review.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted mt-1 d-block">
                                    Selected: <strong id="ratingValue">{{ old('star', 5) }}</strong> / 5 stars
                                </small>
                                @error('star')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // flex-row-reverse ব্যবহার করায় label গুলো visually 1→5 order এ দেখায়
    // কিন্তু DOM এ 5→1 আছে, তাই highlight logic টা adjust করা হয়েছে
