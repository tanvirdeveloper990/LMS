            ...
            <div class="card shadow-lg rounded-3">
                ...
                <div class="card-header text-white bg-gradient-purple">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Preparation Categories</h5>
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ route('admin.preparation-categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="name" class="form-label">Preparation Text </label>
                                <input type="text" name="text" id="text" value="{{ old('text', $category->text) }}"
