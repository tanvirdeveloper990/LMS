            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    {{--<div class="col-md-6 mb-3">
                        <label for="serial" class="form-label">Category Serial <span class="text-danger">*</span></label>
                        <input type="text" name="serial" id="serial" value="{{ old('serial', $category->serial) }}"
                            class="form-control @error('serial') is-invalid @enderror" placeholder="Enter category serial" >
                        @error('serial')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>--}}
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-check form-switch">
                            <input 
                                class="form-check-input @error('show_in_sidebar') is-invalid @enderror" 
                                type="checkbox" 
                            ...
                            <label class="form-check-label" for="show_in_sidebar">
                                <i class="fas fa-bars me-1"></i> Show in Sidebar Menu
                            </label>
                            <small class="d-block text-muted mt-1">Display this category in the sidebar navigation menu</small>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-check form-switch">
                            <input 
                                ...
                                id="show_home_page"
                                value="1"
                                {{ old('show_home_page', $category->show_home_page) ? 'checked' : '' }}
                            >
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-check form-switch">
                            <input 
                                ...
                                id="popular_category"
                                value="1"
                                {{ old('popular_category', $category->popular_category) ? 'checked' : '' }}
                            >
