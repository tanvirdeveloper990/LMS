...
<div class="container py-5">
    ...
    <div class="card shadow-lg border-0 rounded-4 col-8 mx-auto">
        ...
        <!-- Form -->
        <div class="card-body">
            <form action="{{ route('admin.bannars.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="product_link" name="product_link" value="{{ old('product_link') }}"
                    ...
                    <div class="col-md-12">
                        <label for="image" class="form-label">Banner Image <small class="text-muted">(1265px × 600px)</small></label>
