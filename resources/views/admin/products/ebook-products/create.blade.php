...
@section('title','Create Ebook Product')
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header text-white bg-gradient-purple">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Ebook Product</h5>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.ebook-products.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="unit" class="form-control" value="{{ old('unit') }}" placeholder="pcs, copy etc">
                                    </div>
                                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn text-white bg-gradient-purple px-4">
                                <i class="fa fa-save me-1"></i> Create Ebook Product
                            </button>
                        </div>
                    </div>
                </div>
