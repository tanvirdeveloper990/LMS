                        ...
                        <tr>
                            ...
                            <td>
                                @if($color->image)
                                    <img src="{{ Storage::url($color->image) }}" alt="{{ $color->name }}"
                                        style="width:36px;height:36px;object-fit:cover;border-radius:6px;border:1px solid #ddd;">
                                @else
                                    <span style="display:inline-block;width:36px;height:36px;border-radius:6px;background:{{ $color->code ?? '#e5e7eb' }};border:1px solid #ddd;"></span>
                                @endif
                            </td>
                            <td>{{ $color->name }}</td>
                            <td>{{ $color->code }}</td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2 flex-wrap">
                                    <a href="{{ route('admin.colors.edit', $color->id) }}" class="btn btn-primary btn-sm">
                                    ...
                                    <button type="button" data-id="{{ $color->id }}" class="btn btn-danger btn-sm delete-btn">
