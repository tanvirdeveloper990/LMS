                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.settings.update', $data->id) }}" method="POST"
                            ...
                            <div class="border rounded-3 p-4 mb-4">
                                <h6 class="fw-bold text-purple mb-3"><i class="fa fa-info-circle me-2"></i>Basic Information
                                </h6>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="working" name="working" value="{{ $data->working }}"
                            ...
                            <div class="border rounded-3 p-4 mb-4">
                                ...
                                <div class="row g-3">
                                    @foreach (['header_logo' => 'Header Logo', 'footer_logo' => 'Footer Logo', 'favicon' => 'Favicon', 'payment_image' => 'Payment Image'] as $field => $label)
                                            ...
                                            <div class="mt-2">
                                                @if ($data->$field)
                                                    <img id="preview-{{ $field }}"
                                                        src="{{ Storage::url($data->$field) }}" class="img-thumbnail"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold d-flex align-items-center gap-2">
                                                <span
                                                    class="d-inline-flex align-items-center justify-content-center text-white fw-bold rounded"
                            ...
                            <!-- ===== Google Maps ===== -->
                            <div class="border rounded-3 p-4 mb-4">
                                <h6 class="fw-bold text-purple mb-3"><i class="fa fa-map-marker-alt me-2"></i>Google Maps
                                </h6>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="card border-0 shadow-sm rounded-3 mb-4">
                                <div class="card-header bg-white border-bottom py-3">
                                    <h6 class="mb-0 fw-bold text-purple"><i class="fa fa-headset me-2"></i>Footer Section
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                ...
                ">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="scrolling_text_3"
                                                    ...
                                                    class="form-control border-start-0" placeholder="e.g. Get Yours Now"
                                                    oninput="refreshMarqueePreview()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="marquee_speed" class="form-select"
                                                onchange="updateMarqueeSpeed(this.value)">
                                                <option value="10s"
                                                    {{ ($setting->marquee_speed ?? '') == '10s' ? 'selected' : '' }}>Very
                                                    Fast</option>
                                                <option value="20s"
                                                    {{ ($setting->marquee_speed ?? '') == '20s' ? 'selected' : '' }}>Fast
                                                </option>
                                                <option value="40s"
                                                    {{ ($setting->marquee_speed ?? '40s') == '40s' ? 'selected' : '' }}>
                                                    Normal (Default)</option>
                                                <option value="55s"
                                                    {{ ($setting->marquee_speed ?? '') == '55s' ? 'selected' : '' }}>Slow
                                                </option>
                                                <option value="70s"
                                                    {{ ($setting->marquee_speed ?? '') == '70s' ? 'selected' : '' }}>Very
                                                    Slow</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <p class="text-muted mb-0" style="font-size: 11px;">
                                                ...
                                                <span id="sep-demo"
                                                    style="color: {{ $setting->marquee_separator_color ?? '#f97316' }}; font-weight: bold;">✦</span>
                                                separator থাকবে।
                                            </p>
                                        </div>
