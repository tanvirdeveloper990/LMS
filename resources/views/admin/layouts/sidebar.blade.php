<nav id="sidebar">
    ...
    <ul class="nav flex-column mt-1">
                ...
                <div class="collapse {{ $categoryActive ? 'show' : '' }}" id="categoryMenu">
                    <ul class="nav flex-column">
                        ...
                        @canany(['create subcategory', 'edit subcategory', 'view subcategory', 'delete subcategory'])
                            <li><a class="nav-link {{ request()->is('admin/subcategories*') ? 'active' : '' }}"
        ...
        @canany(['create product', 'edit product', 'view product', 'delete product'])
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ $productActive ? 'show' : '' }}" id="productMenu">
                    <ul class="nav flex-column">
                        <li><a class="nav-link {{ request()->is('admin/products*') && !request()->is('admin/products/create') ? 'active' : '' }}"
                                href="{{ route('admin.products.index') }}">
                                <i class="fas fa-th-large menu-icon"></i> All Products
                            </a></li>
                        <li><a class="nav-link {{ request()->is('admin/products/create') ? 'active' : '' }}"
                                href="{{ route('admin.products.create') }}">
                                <i class="fas fa-plus menu-icon"></i> Add Product
                            </a></li>
                        <li><a class="nav-link {{ request()->is('admin/colors*') ? 'active' : '' }}"
                                href="{{ route('admin.colors.index') }}">
                                <i class="fas fa-palette menu-icon"></i> Colors
                            </a></li>
                        <li><a class="nav-link {{ request()->is('admin/sizes*') ? 'active' : '' }}"
                                href="{{ route('admin.sizes.index') }}">
                                <i class="fas fa-ruler menu-icon"></i> Sizes
                            </a></li>
                        <li><a class="nav-link {{ request()->is('admin/brands*') ? 'active' : '' }}"
        ...
        <li class="nav-item">
            <a href="{{ route('admin.ebook-library.index') }}"
