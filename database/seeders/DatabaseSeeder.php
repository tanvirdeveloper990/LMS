    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'delete level',
             ...
             // level-widthdrawal permissions
            'create level-widthdrawal',
            'edit level-widthdrawal',
            'view level-widthdrawal',
            'delete level-widthdrawal',

             // level-report permissions
            'create level-report',
            'edit level-report',
            'view level-report',
            'delete level-report',
